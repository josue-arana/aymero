...
assert.match(projectSource, /id: 'create-invoice',[\s\S]*onClick: onCreateInvoice/)
...
assert.match(appSource, /navigate\(`\/invoices\/\$\{persistedInvoice\.id\}`,\s*\{\s*state: withNavigationContext\(\{\}, invoiceModalState\.returnTo/)
