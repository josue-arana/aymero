  ...
  try {
    ...
    if (!records.estimate) {
      records.estimate = await createEntity('estimate', {
        ...
        lineItems: [
          { name: 'Cabinetry and installation', amount: 10000, materialsIncluded: true },
          { name: 'Countertops and finish work', amount: 6000, materialsIncluded: true },
          { name: 'Lighting and flooring', amount: 4000, materialsIncluded: true },
        ],
        subtotal: 20000,
        total: 20000,
